	...
	\subsection{Integration testing}
		\subsubsection{Travis Continueous Integration}
			\begin{enumerate}
			    ...
			    \begin{center}
			        \includegraphics[width=1\linewidth]{Images/TravisCI_2.png}
			    \end{center}
			    
			    \item We have setup our integration tests to also do unit testing, this ensures that every time code is pushed to a branch, that all of the functions still work as they are supposed to work, this does take a bit longer as displayed, but it ensures that we know the moment when something breaks. 
