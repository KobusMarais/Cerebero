...
router.post('/getStances', function(req, res, next) { // receives user score and inserts into leaderboard
    ...
    var text = "{\n" +
        "\t\"stances\":[{\"1\":[{\"Far Left\" : \"Restorative Justice\"}, {\"Left\" : \"Rehabilitation\"}, {\"Centre\" : \"Prevention\"}, {\"Right\" : \"Punishment\"}, {\"Far Right\" : \"Increased Sentencing\"}]},{\"2\":[{\"Far Left\" : \"Abolishing Borders\"}, {\"Left\" : \"Relaxed Immigrations Laws\"}, {\"Centre\" : \"Control Borders\"}, {\"Right\" : \"Strict Enforcement of Immigration Laws\"}, {\"Far Right\" : \"Stricter Immigration Laws\"}]},{\"3\":[{\"Far Left\" : \"Ban All Firearms\"}, {\"Left\" : \"Guns Reserved For Law Enforcement\"}, {\"Centre\" : \"Strict Firearm Regulation\"}, {\"Right\" : \"Light Firearm Regulation\"}, {\"Far Right\" : \"Relaxed Firearm Regulation\"}]},{\"4\":[{\"Far Left\" : \"State Owned Media\"}, {\"Left\" : \"Regulated Media\"}, {\"Centre\" : \"Strong Enforcement of Press Code\"}, {\"Right\" : \"Self-Regulation By Media\"}, {\"Far Right\" : \"Completely Free Media\"}]},{\"5\":[{\"Far Left\" : \"Restorative Justice\"}, {\"Left\" : \"Rehabilitation\"}, {\"Centre\" : \"Prevention\"}, {\"Right\" : \"Punishment\"}, {\"Far Right\" : \"Increased Sentencing\"}]}]\n" +
        "}";
    var obj = JSON.parse(text);
    res.send(obj);
});
