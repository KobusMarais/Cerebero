...
router.post('/api/v1/todos', (req, res, next) => {
  ...
  const data = {username: req.body.data.username,
  ...
  pg.connect(connectionString, (err, client, done) => {
    ...
    client.query('INSERT INTO users(userename, password ,complete) values($1, $2, $3)',
    [data.username, data.password, data.complete]);
    // SQL Query > Select Data
